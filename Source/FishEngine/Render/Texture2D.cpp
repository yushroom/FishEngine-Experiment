#include <FishEngine/Render/Texture2D.hpp>
...
namespace FishEngine
{
	...
	FishEngine::Texture2D* Texture2D::whiteTexture()
	{
		static Texture2D* m_whiteTexture = new Texture2D(2, 2, TextureFormat::RGBA32, allWhite, 2 * 2 * 4);
		return m_whiteTexture;
	}

	FishEngine::Texture2D* Texture2D::blackTexture()
	{
		static Texture2D* m_blackTexture = new Texture2D(2, 2, TextureFormat::RGBA32, allBlack, 2 * 2 * 4);
